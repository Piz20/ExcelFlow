...
<p>Merci de trouver en pièce jointe ci-dessous l'analyse de votre compte support pour [JOURNEE_OU_JOURNEES_DU] <strong>[DATE_OU_INTERVALLE_JOURS_ANALYSE]</strong>, ayant permis d'aboutir au solde final (avant cash out auto) de <span style='color: #f51b1b;'><strong>[SOLDE_FINAL] XAF</strong></span>.</p>
